...
contract StarNotary is ERC721 {
    ...
    constructor(string memory name_, string memory symbol_, uint256 tokenId_)ERC721(name_, symbol_, tokenId_){
        Star memory newStar = Star(name_, symbol_, tokenId_);
        tokenIdToStarInfo[tokenId_] = newStar;
    ...
    function createStar(string memory _name, string memory _symbol, uint256 _tokenId) public { // Passing the name and tokenId as a parameters
        Star memory newStar = Star(_name, _symbol, _tokenId); // Star is an struct so we are creating a new Star
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        approveToBuyTrade(msg.sender, _tokenId);
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        Star memory thisStar = tokenIdToStarInfo[_tokenId];
        return thisStar.name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if(msg.sender == ownerOfToken1){
            approveToBuyTrade(msg.sender, _tokenId2);
            approveToBuyTrade(ownerOfToken2, _tokenId1);
            ...
            approveToBuyTrade(msg.sender,_tokenId1);
            approveToBuyTrade(ownerOfToken1, _tokenId2);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        require(msg.sender == ownerOf(_tokenId), "You can't transfer a token you do not own.");
